...
namespace Frertex::Transpilers::SPIRV
{
	...
	$$Template:Insert,"InstructionImpl.h",NAME=INSTRUCTION.NAME,ARGUMENTS=INSTRUCTION.ARGUMENTS,OPCODE=INSTRUCTION.OPCODE,CAPABILITIES=INSTRUCTION.CAPABILITIES,EXTENSIONS=INSTRUCTION.EXTENSIONS$$
	$$End$$
